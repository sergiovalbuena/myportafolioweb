export const themes = {
    light: {
        ...
        cardHover: {
            ...
            boxShadow: `inset 0px 0px 0px .5px rgba(68, 66, 178, .1)`,
        },
        pricingCard: {
    ...
    dark: {
        ...
        modal: {
            ...
            boxShadow: `0px 50px 100px rgba(0,0,0,.25), inset 0 0 0 .5px rgba(255,255,255,.3)`,
            backgroundColorFull: `rgba(15,14,71,1)`,
